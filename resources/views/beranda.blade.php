...
<div class="super_container">
            ...
            <div class="row fill_height">
                <div class="col fill_height">
                    ...
                    <div class="search_panel active">
                        <form action="{{route('search.api')}}" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                            <div class="search_item">
                                <div>asal</div>
                                <select name="stasiun_asal" id="asal" class="dropdown_item_select search_input">
                                @foreach( $stasiun['data'] as $sts )
                                    <option value="{{$sts['id_stasiun']}}">{{$sts['nama_stasiun']}}</option>
                                @endforeach
                                </select>
                            </div>
                            <div class="search_item">
                                <div>tujuan</div>
                                <select name="stasiun_tujuan" id="tujuan" class="dropdown_item_select search_input">
                                @foreach( $stasiun['data'] as $sts )
                                    <option  value="{{$sts['id_stasiun']}}">{{$sts['nama_stasiun']}}</option>
                                @endforeach
                                </select>
                            ...
                            <div class="search_item">
                                <div>berangkat</div>
                                <input type="text" name="date_start" class="check_in search_input datepicker" readonly="readonly">
                            </div>
                            <div class="search_item">
                                <div>penumpang</div>
                            ...
                            <button type="submit" class="button search_button">cari <i class="fa fa-search fa-lg"></i></button>
                        </form>
                    </div>  
                </div>
            </div>
        ...
        <div class="home_slider_container">
            ...
            <div class="owl-carousel owl-theme home_slider">
                ...
                <div class="owl-item home_slider_item">
                    ...
                    <div class="home_slider_background" style="background-image:url(tiketkai/images/home_slider.png)"></div>
    ...
    <div class="intro">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="intro_title text-center">RUTE KERETA PILIHAN</h2>
                </div>
            </div>
            <!-- <div class="row">
            ...
            <div class="row intro_items">
                ...
                <div class="col-lg-4 intro_col">
                    <div class="intro_item">
                        ...
                        <div class="intro_item_background" style="background-image:url(tiketkai/images/intro_1.jpg)"></div>
                        <div class="intro_item_content d-flex flex-column align-items-center">
                            <div class="intro_date">Menuju ke</div>
                            <div class="intro_center text-center">
                                <h1>Gambir, Jakarta</h1>
                            </div>
                            <!-- <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more</a></div> -->
                            <div class="intro_center text-center">
                                <h2><a href="#">Scotland</a></h2>
                                <div class="intro_price"><a href="#">Rp. 110.000</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 intro_col">
                    <div class="intro_item">
                        ...
                        <div class="intro_item_background" style="background-image:url(tiketkai/images/intro_2.jpg)"></div>
                        <div class="intro_item_content d-flex flex-column align-items-center">
                        <div class="intro_date">Menuju ke</div>
                            <div class="intro_center text-center">
                                <h1>Gubeng, Surabaya</h1>
                            </div>
                            <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more</a></div>
                            <div class="intro_center text-center">
                                <h2>Scotland</h2>
                ...
                <div class="col-lg-4 intro_col">
                    <div class="intro_item">
                        ...
                        <div class="intro_item_background" style="background-image:url(tiketkai/images/intro_3.jpg)"></div>
                        <div class="intro_item_content d-flex flex-column align-items-center">
                            <div class="intro_date">Menuju ke</div>
                            <div class="intro_center text-center">
                                <h1>Lempuyangan, Yogyakarta</h1>
                            </div>
                            <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more</a></div>
                            <div class="intro_center text-center">
                                <h2>Scotland</h2>
