...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{url('tiketkai/images/about_background.jpg')}}"></div>
	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					<div class="intro_image"><img src="{{url('tiketkai/images/intro.png')}}" alt=""></div>
				</div>
				<div class="col-lg-5">
					<div class="intro_content">
						<div class="section_title">we have the best tours</div>
				...
				<div class="col">
					<div class="stats_contents">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="{{url('tiketkai/images/stats_1.png')}}" alt="">
								</div>
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="{{url('tiketkai/images/stats_2.png')}}" alt="">
								</div>
								<div class="stats_last_content">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="{{url('tiketkai/images/stats_3.png')}}" alt="">
								</div>
								<div class="stats_last_content">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								<div class="stats_last_icon d-flex flex-column align-items-center justify-content-end">
									<img src="{{url('tiketkai/images/stats_4.png')}}" alt="">
								</div>
								<div class="stats_last_content">
			...
			<div class="row">
				<div class="col">
					<div class="add_container">
						<div class="add_background" style="background-image:url(tiketkai/images/add.jpg)"></div>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{url('tiketkai/images/milestone_1.png')}}" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{url('tiketkai/images/milestone_2.png')}}" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{url('tiketkai/images/milestone_3.png')}}" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="{{url('tiketkai/images/milestone_4.png')}}" alt=""></div>
